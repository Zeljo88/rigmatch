...
### CV07 — short-messy
- Passed fields: name, highestEducation, jobTitles, companies, experienceYears, roleNormalization
- Failed fields:
  - `location` | severity: **high** | cause: Profile schema does not capture location, so matching/search cannot rely on it | fix: Add location extraction + normalized location model + review/edit support
...
### CV17 — all-caps
- Passed fields: highestEducation, jobTitles, skills, experienceYears, roleNormalization
- Failed fields:
...
- **experience-extraction**
  - CV17 / companies: Improve company/title boundary detection in experience parsing.
  - CV19 / jobTitles: Improve experience-section segmentation and title extraction before role normalization.